    ...
    <div className="w-full text-center mt-0 py-3 bg-Blue-3000">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="flex flex-col items-center">
          <img src="Group2.png" alt="Requirement Gathering" className="w-40 h-32 0bject-cover mb-4" />
          <h3 className="text-xl font-bold mb-2">Requirement Gathering</h3>
          <p className="text-gray-700">We begin by thoroughly understanding your business objectives, target
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-700">Once we have gathered all the requirements, we conduct a thorough
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-700">Once we have a solid understanding of your requirements and a detailed
