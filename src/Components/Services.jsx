...
const servicesData = [
  {
    ...
    content: 'Our expert team of designers will work closely with you to create a visually stunning website that will strongly reflect your brand identity and resonate with your mission. Our emphasis on user experience (UX) and user interface (UI) design principles will ensure your website not only looks pleasant but also gives a great user experience.',
  },
  {
    id: 2,
    image: 'service2.png',
...
const Services = () => {
  return (
    <>
      <NavBar />
      <div className="container mx-auto text-center mt-20 mb-4">
        <h2 className="text-3xl md:text-4xl font-bold mb-20">Our Services</h2>
